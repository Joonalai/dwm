...
static const char *obsscratchpadcmd[] = {"z", "obsidian", NULL};
static const char *spscratchpadcmd[] = {"s", "alacritty", "-t", "spt", "-e", "spt", NULL};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_z,      togglescratch,  {.v = obsscratchpadcmd } },
